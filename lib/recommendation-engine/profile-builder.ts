...
const STYLE_ICON_SIGNAL_MAP: Record<StyleIcon, Signal[]> = {
  ...
  hailey_bieber: ["stylish", "cool", "modern"],
  tom_hardy: ["grounded", "natural", "menacing"],
  kim_go_eun: ["intellectual", "grounded", "minimal"],
  gong_yoo: ["intellectual", "grounded", "minimal"],
  billie_eilish: ["edgy", "artsy", "introspective"],
  g_dragon: ["edgy", "artsy", "introspective"],
  dakota_johnson: ["effortless", "stylish", "cool"],
  jacob_elordi: ["effortless", "stylish", "cool"],
  ...
  zoe_kravitz: ["free_spirited", "playful", "artsy"],
  brad_pitt: ["free_spirited", "playful", "natural"],
  zendaya: ["confident", "stylish", "modern"],
  harry_styles: ["bold", "stylish", "modern"],
};
...
const MOOD_SIGNAL_MAP: Record<Mood, Signal[]> = {
  ...
  effortless_cool_woke_up_like_this: ["effortless", "cool", "stylish"],
  playful_warm_unexpected: ["playful", "warm", "enigmatic"],
  grounded_calm_quiet_luxury: ["grounded", "introspective", "elegant"],
  mysterious_edgy_artistic: ["mysterious", "edgy", "artsy"],
};
