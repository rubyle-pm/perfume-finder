...
const REVIEW_QUESTIONS = [
  ...
  },
  {
    ...
    mandatory: true,
    options: [
      { value: "cozy_solo_cafe",        label: "Cozy solo café",       emoji: "☕" },
      { value: "museum_gallery",        label: "Museum wandering",     emoji: "🖼️" },
      { value: "hiking_outdoor",        label: "Outdoor adventure",    emoji: "🏔️" },
      { value: "long_brunch",           label: "Long brunch",          emoji: "🥐" },
      { value: "home_reset",            label: "Home-body",            emoji: "🛋️" },
      { value: "spontaneous_road_trip", label: "Road trip",            emoji: "🚗" },
      { value: "book_blanket_hermit",   label: "Book & blanket",       emoji: "😶‍🌫️" },
      { value: "late_night_social",     label: "Late night social",    emoji: "🍸" },
    ],
  },
  {
    id: "style_icon",
    ...
    mandatory: false,
    options: [
      { value: "clean_girl",             label: "Clean girl",           emoji: "🤍" },
      { value: "soft_girl_next_door",    label: "Soft, girl-next-door", emoji: "🌸" },
      { value: "modern_feminine",        label: "Modern feminine",      emoji: "👗" },
      { value: "effortless_chic",        label: "Effortless chic",      emoji: "✨" },
      { value: "timeless_elegance",      label: "Timeless elegance",    emoji: "🫧" },
      { value: "classic_bombshell",      label: "Classic bombshell",    emoji: "💄" },
      { value: "sporty_glam",            label: "Sporty glam",          emoji: "🏅" },
      { value: "boho_indie",             label: "Boho indie",           emoji: "🌙" },
      { value: "rebellious_gen_z",       label: "Rebellious, Gen Z",    emoji: "🔥" },
      { value: "coquette",               label: "Coquette",             emoji: "🎀" },
      { value: "modern_masculinity",     label: "Modern masculinity",   emoji: "🌊" },
      { value: "pretty_prince",          label: "Pretty prince",        emoji: "🌹" },
      { value: "dark_intellectual_male", label: "Dark intellectual",    emoji: "📖" },
      { value: "old_money_masculine",    label: "Old money masculine",  emoji: "🏛️" },
      { value: "quiet_luxury_feminine",  label: "Quiet luxury feminine",emoji: "🕊️" },
      { value: "street_culture",         label: "Street culture",       emoji: "🎿" },
    ],
  },
  {
    id: "mbti",
  ...
  },
  {
    ...
    mandatory: false,
    options: [
      { value: "cottage_core",         label: "Cottage core",          emoji: "🌼" },
      { value: "streetwear_hiphop",    label: "Streetwear / Hip-hop",  emoji: "🧢" },
      { value: "modern_parisian_chic", label: "Modern Parisian chic",  emoji: "🥐" },
      { value: "y2k_trendy",           label: "Y2K and trendy",        emoji: "💿" },
      { value: "scandinavian_minimal", label: "Scandinavian minimal",  emoji: "🌿" },
      { value: "old_money_european",   label: "Old money / European",  emoji: "🏛️" },
